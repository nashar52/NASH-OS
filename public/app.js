...
async function employeePerformanceApp() {
  ...
  document.querySelector('[data-performance-self-review]')?.addEventListener('click', () => permissionReceipt('EMPLOYEE_PERFORMANCE_SELF_REVIEW', { target: employeeLabel(), note: 'Employee opened a controlled self-review request.' }));
}
