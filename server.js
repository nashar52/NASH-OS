...
app.post('/api/permissioned-action', async (req, res) => {
  try {
    ...
    const allowed = {
      employee: ['EMPLOYEE_PROFILE_EDIT_REQUEST','SUBMIT_EVIDENCE','EDIT_DRAFT_EVIDENCE','DELETE_DRAFT_EVIDENCE','SELECT_EMPLOYEE','EMPLOYEE_DOCUMENT_UPLOAD','EMPLOYEE_DOCUMENT_REPLACE','EMPLOYEE_DOCUMENT_ARCHIVE','DOCUMENT_DOWNLOAD','CHECK_IN','START_WORKDAY','CHECK_OUT','START_TASK','EMPLOYEE_PERFORMANCE_SELF_REVIEW','EMPLOYEE_SERVICE_REQUEST'],
