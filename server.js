...
function sprint24Receipt(req, actionType, advisory) { const timestamp = new Date().toISOString(); const receipt = { receiptId:sprint24Id('AI-RCT'), timestamp, actor:req.accessSession.email, actorRole:req.accessSession.role, tenant:req.accessSession.tenant, actionType, advisoryId:advisory.advisoryId, subjectType:advisory.subjectType, subjectId:advisory.subjectId, sourceLabels:advisory.sourceLabels, confidence:advisory.confidenceLevel, humanReviewRequired:true, workflowReference:advisory.workflowReference, evidenceReference:advisory.evidenceReferences, decisionStatus:advisory.humanDecisionStatus }; const audit = { auditEventId:sprint24Id('AI-AUD'), timestamp, tenant:receipt.tenant, actor:receipt.actor, actorRole:receipt.actorRole, actionType, advisoryId:advisory.advisoryId, requestId:req.requestId }; receipt.auditEventId=audit.auditEventId; sprint24Runtime.receipts.unshift(receipt); sprint24Runtime.audit.unshift(audit); return receipt; }
